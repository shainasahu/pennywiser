...
export default function History({ onClose }) {
  const transactions = [
    ...
    { id: 2, date: "2025-09-22", category: "Transport", amount: 38.0, description: "Uber" },
    { id: 3, date: "2025-09-20", category: "Bills", amount: 120.0, description: "Electricity Bill" },
    ...
    { id: 8, date: "2025-08-21", category: "Bills", amount: 95.0, description: "Internet Bill" },
    { id: 9, date: "2025-08-18", category: "Shopping", amount: 149.99, description: "Target" },
    { id: 10, date: "2025-08-14", category: "Transport", amount: 25.0, description: "Gas Station" },
    ...
    // JULY 2025
    { id: 13, date: "2025-07-30", category: "Bills", amount: 130.0, description: "Rent" },
    ...
    { id: 17, date: "2025-07-10", category: "Transport", amount: 60.0, description: "Metro Pass" },
    { id: 18, date: "2025-07-05", category: "Entertainment", amount: 22.0, description: "Movie Theater" },

    // JUNE 2025
    { id: 19, date: "2025-06-28", category: "Bills", amount: 110.0, description: "Water Bill" },
    ...
    { id: 23, date: "2025-06-05", category: "Transport", amount: 18.0, description: "Bus Pass" },
    { id: 24, date: "2025-06-02", category: "Food", amount: 15.0, description: "McDonald's" },

    // MAY 2025
    { id: 25, date: "2025-05-29", category: "Bills", amount: 125.0, description: "Rent" },
    { id: 26, date: "2025-05-20", category: "Food", amount: 10.75, description: "Bakery" },
    { id: 27, date: "2025-05-16", category: "Transport", amount: 40.0, description: "Uber" },
    ...
    // APRIL 2025
    { id: 31, date: "2025-04-30", category: "Bills", amount: 105.0, description: "Phone Bill" },
    ...
    { id: 34, date: "2025-04-15", category: "Transport", amount: 22.0, description: "Uber" },
